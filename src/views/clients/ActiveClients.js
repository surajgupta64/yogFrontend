        ...
        <CRow>
            <CCol lg={12} sm={12}>
                <CCard className='mb-3 border-top-success border-top-3'>
                    <CCardHeader>
                        <strong className="mt-2">Active Clients <span className='float-end'>Total Active Clients : {result1.filter((list) => list.username === username && list.plan === true).length}</span></strong>
                    </CCardHeader>
                    <CCardBody>
