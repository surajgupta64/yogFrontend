                                ...
                                {staff.filter((list) =>
                                    ...
                                    item.username === username && (
                                        <CTableRow key={index}>
                                            ...
                                            <CTableDataCell>{item.selected}<CButton className='mt-1' color='success' onClick={() => updateRec(item._id, 'Select')} >Select</CButton><CButton className='mt-1' color='danger' onClick={() => updateRec(item._id, 'Reject')}>Reject</CButton></CTableDataCell>
